...
-- AlterTable
ALTER TABLE "Comment" ADD COLUMN     "repostParentId" TEXT;

-- AlterTable
ALTER TABLE "Tweet" ADD COLUMN     "repostParentId" TEXT;
...
-- AddForeignKey
ALTER TABLE "Tweet" ADD CONSTRAINT "Tweet_repostParentId_fkey" FOREIGN KEY ("repostParentId") REFERENCES "Tweet"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Comment" ADD CONSTRAINT "Comment_repostParentId_fkey" FOREIGN KEY ("repostParentId") REFERENCES "Comment"("id") ON DELETE SET NULL ON UPDATE CASCADE;
