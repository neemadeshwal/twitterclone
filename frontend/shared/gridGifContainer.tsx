...
const gridGifContainer = ({ searchGif, fetched,setOpenGifContainer,setFiles }: any) => {
    ...
    <div className="overflow-y-auto h-[80vh] flex flex-wrap ">
      {!searchGif ? (
        <Grid
          ...
          onGifClick={(gif,event) => {console.log(gif);event.preventDefault(); setSelectedGif(gif.images.original.url)}}
