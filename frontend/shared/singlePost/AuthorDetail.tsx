    ...
    <div>
      <div className="flex justify-between w-full">
        <div className="flex flex-col xs:flex-row items- sm:gap-1 sm:items-center">
          <div onClick={redirectPage} className="hidden xs:inline-block">
          ...
          <div className="flex items-start sm:items-start gap-px flex-col">
            <p
              ...
              className="capitalize font-[600] xs:hidden  md:text-[17px] text-[15px] leading-[20px]"
            >
              {author?.firstName} {author?.lastName}
            </p>
            ...
            <div className="flex">
              <p
                onClick={redirectPage}
                className="xs:hidden gray text-[15px] block leading-[19px] font-[400]"
              >
                @{author?.userName}
              </p>
