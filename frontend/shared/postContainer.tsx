...
const PostContainer = () => {
  ...
  return (
    <div>
          <div onClick={()=>setIsContainerOpen(true)} className="p-2 bg-white padding text-black w-fit  flex  fullWidth rounded-full my-2 cursor-pointer">
          ...
          {
            isContainerOpen&& <div className="fixed top-0 left-0 w-full h-full z-[10000000000] dimBg flex items-center justify-center">
