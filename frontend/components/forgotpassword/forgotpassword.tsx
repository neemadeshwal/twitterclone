          ...
          <div className="w-screen h-screen fixed top-0 left-0 z-50 dimBg flex items-center justify-center ">
            <div className="bg-black w-full  md:w-[600px]   h-full md:h-[700px]  rounded-none md:rounded-[20px] ">
              ...
              <div className="flex relative flex-col w-full h-[90%]">
                <div className="  p-4 px-8 sm:px-[10vw] md:px-20 h-4/5 pt-10 overflow-auto ">
                  <div>
                    <div>
                      <h4 className="font-[700] text-[31px] leading-[36px]">
                        ...
                        {authData.next_page === "checkemail"
                          ...
                          : authData.next_page==="newpass"?"Choose a new password":
                          authData.next_page==="verifyotp"?"We sent you a code":null
                          }
                        {/* Sign in to X */}
                      </h4>
                      {
                     ...
                     
                      {
                        authData.next_page=="confirmyou"&&
                        <p className="text-gray-400 text-[13px] mt-1">
                       Before you can change your password, we need to make sure it’s really you.<br/>
                    ...
                    <div className="py-[18px] h-full">
                      {authData.next_page === "checkemail" ? (
                        <Step1CheckEmail forgotpass={true} setAuthData={setAuthData} />
                      ) : authData.next_page === "confirmyou" ? (
                      <Step2ConfirmYou authEmail={authData.email} setAuthData={setAuthData}/>
                      ) : (
                        authData.next_page==="verifyotp"?
                        <Step2VerifyOtp setGetData={setAuthData} authType="forgotpass"
                        data={authData}/>:
                        authData.next_page==="newpass"?
                        <Step3NewPass data={authData} setGetData={setAuthData} />:null
                ...
                <div
                  className="py-1 px-6 sm:px-20  items-center flex justify-center pt-6"
                >
                  <button
