  ...
  export const useCommentMutation = ({ onSuccess, onError }: useCommentMutationProps = {}) => {
      ...
      const createComment = async (body: CreateCommentProps) => {
        ...
        return { createComment,likeComment,replyOnComment,repostComment,deleteComment,isRepostingComment:repostCommentMutation.isPending,isTogglingLike:likeCommentMutation.isPending,isReplyOnComment:replyOnCommentMutation.isPending, isCreatingComment:createCommentMutation.isPending };
      };